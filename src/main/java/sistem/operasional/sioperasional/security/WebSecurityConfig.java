...
//     }
    ...
    protected void configure(HttpSecurity http) throws Exception {
        http
                ...
                .antMatchers("/training/schedule/**").hasAnyAuthority("Operation Manager", "Operaton Lead", "Operation Staff")
                .antMatchers("/jenis-outlet/**").hasAnyAuthority("Operation Manager", "Product Operation Specialist", "Operaton Lead")
